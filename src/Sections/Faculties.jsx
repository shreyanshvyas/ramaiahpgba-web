    ...
    const facultyInfo = [
        {
            ...
            "desc":"Lijin holds a postgraduate qualification in marketing with 11 years of extensive work experience. With significant contributions to notable projects at RBS, RCMAS, Christ, and MIT. Lijin specializes in teaching Advanced Excel, Visualization using Power BI and Tableau, and HR Analytics. Proficient in tools like Excel, SPSS, Orange 3, Tableau, and Power BI, Lijin has shared expertise across various locations including Kochi, Noida, Chennai, Coimbatore, and Bangalore."
        },
        {
            "name": "Bharat Sharma",
            "img": bharat,
            "title": "Consultant, KPMG in India",
            "shortDesc": "Bharat holds a degree in Physics (H) along with Lean Six Sigma Green Belt certification. With years of experience in Six Sigma Consulting and analytics automation, Bharat ",
            "desc": "Bharat is a Physics (H) graduate and Lean Six Sigma Green Belt certified professional. With expertise in Six Sigma consulting and analytics automation, Bharat has led process optimization projects at EIL and implemented analytics capability chains at GATI using Python. He also teaches courses in Data Visualization, Machine Learning, and HR Analytics, providing training programs that bring a global perspective from his experience in India and Bahrain (GCC)."
        },
        {
            "name": "Varsha Pai K.",
            "img": varsha,
            "title": "Senior Consultant, KPMG in India",
            "shortDesc": "Varsha brings nine years of experience in training and operations, specializing in E-Learning and Training-Project Management. With a BE in Information Science and CSM certification, Varsha excels in ",
        ...
        },
        {
            ...
            "img": pranab,
            "title": "Consultant, KPMG in India",
            "shortDesc": "Pranab holds a B.Tech and MBA qualification with 3.5 years of experience. He has contributed to marquee projects at MDI Gurgaon, IIFT Delhi, and Christ University. Pranab ",
        ...
        },
        {
            ...
            "shortDesc": "Dr. Aravinda Reddy M N is an Associate Professor and HOD - Business Analytics and Data Science at Ramaiah Institute of Management, Bangalore. He has completed ",
        ...
        <section className="md:py-[60px] lg:py-[80px] py-[50px] bg-[#FAFAFA]" id="faculty">
            <div className="container mx-auto px-3 md:px-10">
                <div className="mb-[50px]">
                    <Title name="Experienced" colored="Faculties"/>
                </div>
                        ...
                        facultyInfo.map((singleFaculty,index)=> (
                                <>
                                    ...
                                    <div className="flex flex-col lg:flex-row border rounded-lg border-navy p-5 bg-white z-1 relative">
                                        ...
                                        <div className="text-navy flex flex-col justify-center sm:items-start items-center">
                                            <h3 className="text-[20px] mb-1 font-bold font-flama">{singleFaculty.name}</h3>
                                            <span className="text-[14px] w-52 md:w-full text-center md:text-start mb-2 inline-block font-flama">{singleFaculty.title}</span>
