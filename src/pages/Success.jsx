    ...
    return (
        <>
            ...
            <section className="bg-cover h-screen flex justify-center mt-24" style={{backgroundImage: `url(${successBg})`,
                ...
                backgroundBlendMode: 'darken'}} id="home">
                <div className='text-center backdrop-blur-md md:p-10 p-5 h-max mt-20 rounded-md md:max-w-[550px] max-w-[300px]'>
                    ...
                    <p className='text-white font-garamond md:text-[25px] text-[18px] mb-8'>Registration successful. Kindly check your email for further instructions. Our counsellor will reach out to shortly.</p>
